    ...
    <main className="px-5 py-7 sm:px-7 sm:py-9 xl:px-10">
      <div className="mx-auto max-w-[1280px]">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div>
            <p className="text-sm font-semibold text-[#ff4800]">Notifications</p>
            <h1 className="mt-1 text-2xl font-semibold sm:text-3xl">Email delivery</h1>
            <p className="mt-2 text-sm text-[#686864]">Review and send queued reward emails.</p>
          </div>
          <button
            type="button"
            onClick={sendPending}
            disabled={sending}
            className="h-11 bg-[#ff4800] px-5 text-sm font-semibold text-white disabled:bg-[#bd5f39]"
          >
        ...
        <section className="mt-6 border border-[#deded9] bg-white">
          {loading ? (
